"""RabbitMQ connection helpers shared by the outbox publisher and preference consumer.

Same durable topic exchange ("globetrotter.events") as every other service --
see app/messaging/rabbitmq.py in the User Service for the full rationale.
"""
